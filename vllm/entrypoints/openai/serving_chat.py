                ...
                for output in res.outputs:
                    ...
                    # and reasoning parser
                        ...
                        if not reasoning_end_arr[i]:
                            ...
                            # Note: We don't check prompt_token_ids for </think>
                            # here because multi-turn conversations may have
                            # </think> from history assistant messages. The
                            # reasoning_parser handles enable_thinking=False
                            # internally.
                            #
                            # When encountering think end id in delta_token_ids,
                            # set reasoning status to end.
