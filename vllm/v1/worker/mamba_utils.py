...
def _copy_mamba_state_block(
    ...
    if CONV_STATE_DIM_FIRST and is_conv_state:
        ...
        # Stable row-to-lane ownership and low-to-high token order make an
        # in-place left shift behave like memmove instead of memcpy.
    ...
    if is_conv_state:
        ...
        # Each token region is disjoint. Copying tokens from low to high keeps
        # future source tokens intact during an in-place left shift.
        for token_idx in range(0, num_dst_tokens):
